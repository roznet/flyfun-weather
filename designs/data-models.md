...
| `VerticalMotionAssessment` | Vertical motion + turbulence | classification, max_omega_pa_s, max_w_fpm, max_w_level_ft, cat_risk_layers, e_shear_layers, convective_contamination, mixed_layer_top_ft (#533 — reported so the CAT suppression below it is inspectable) |
