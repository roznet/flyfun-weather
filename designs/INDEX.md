...
Key exports: `summarize_trip`, `TripSummary`, `TripLegInput`, `FlightTripRow`, `trip_members`, `prune_empty_trips`, `trip_refresh.start`, `open_scheduler_run`, `ensure_trip_ai_summary`, `check_guardrail`, `bulk_trip_refs`, `is_shareable`, `load_trip_row_for_viewer`, `shared_trip_refs`
