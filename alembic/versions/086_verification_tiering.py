...
``archive_manifest``
    Row-count + checksum record per archived Parquet period. This is the gate
    Phase 3's pruning consults: no manifest, no delete.
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("n_ceiling", sa.Integer(), nullable=False),
        sa.Column("n_wind", sa.Integer(), nullable=False),
        sa.Column("n_temp", sa.Integer(), nullable=False),
        sa.Column("n_vis", sa.Integer(), nullable=False),
        sa.Column("n_cat_match", sa.Integer(), nullable=False),
        sa.Column("n_cat_opt_1", sa.Integer(), nullable=False),
        sa.Column("n_cat_opt_2", sa.Integer(), nullable=False),
        sa.Column("n_cat_pess_1", sa.Integer(), nullable=False),
        sa.Column("n_cat_pess_2", sa.Integer(), nullable=False),
        ...
        sa.Column("n_advisory_match", sa.Integer(), nullable=False),
        sa.Column("n_advisory_opt", sa.Integer(), nullable=False),
        sa.Column("n_advisory_pess", sa.Integer(), nullable=False),
        sa.Column("n_precip_hit", sa.Integer(), nullable=False),
        sa.Column("n_precip_miss", sa.Integer(), nullable=False),
        sa.Column("n_precip_false_alarm", sa.Integer(), nullable=False),
        sa.Column("n_convection_hit", sa.Integer(), nullable=False),
        sa.Column("n_convection_miss", sa.Integer(), nullable=False),
        sa.Column("n_convection_false_alarm", sa.Integer(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("date", sa.Date(), nullable=False),
        sa.Column("source", sa.String(length=16), nullable=False),
        sa.Column("n_scores", sa.Integer(), nullable=False),
        sa.Column("n_distinct_obs", sa.Integer(), nullable=False),
        sa.Column("n_airports_day", sa.Integer(), nullable=False),
        sa.PrimaryKeyConstraint("id"),
